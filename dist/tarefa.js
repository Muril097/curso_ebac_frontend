...
var Aproved = function Aproved(list) {
  return list.filter(function (aluno) {
    return (aluno.nota1 + aluno.nota2 + aluno.nota3 + aluno.nota4) / 4 >= 6;
  });
};
var Reproved = function Reproved(list) {
  return list.filter(function (aluno) {
    return (aluno.nota1 + aluno.nota2 + aluno.nota3 + aluno.nota4) / 4 < 6;
  });
};
var Aprovados = Aproved(alunos);
var Reprovados = Reproved(alunos);
console.log("--- Média dos Alunos ---");
alunos.forEach(function (aluno) {
  console.log("".concat(aluno.nome, ": ").concat((aluno.nota1 + aluno.nota2 + aluno.nota3 + aluno.nota4) / 4, " "));
});
